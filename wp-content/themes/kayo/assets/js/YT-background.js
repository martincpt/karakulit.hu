		...
		init : function ( $container ) {
			...
			setTimeout( function() {
				...
				if ( typeof window.onYouTubePlayerAPIReady !== 'undefined' ) {
					if ( typeof window.KayoOtherYTAPIReady === 'undefined' ) {
						window.KayoOtherYTAPIReady = [];
					}
					window.KayoOtherYTAPIReady.push( window.onYouTubePlayerAPIReady );
				}
				...
				window.onYouTubePlayerAPIReady = function() {
					...
					if ( typeof window.KayoOtherYTAPIReady !== 'undefined' ) {
						if ( window.KayoOtherYTAPIReady.length ) {
							window.KayoOtherYTAPIReady.pop()();
						}
					}
				};
			}, 2 );
