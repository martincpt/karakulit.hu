...
?>
<figure <?php kayo_post_attr( array( $overlay_tone_class ) ); ?>>
	<div class="entry-box">
		<div class="entry-outer">
			<div class="entry-container">
				...
				<?php do_action( 'kayo_work_bg', $template_args, 'metro', $featured ); ?>
				<div class="entry-inner">
					<div class="entry-inner-padding">
						...
						<div style="<?php echo kayo_esc_style_attr( $text_style ); ?>" class="entry-summary">
							...
							<?php do_action( 'kayo_work_metro_summary_start', $template_args ); ?>

							<h3 class="entry-title"><a href="<?php the_permalink(); ?>" style="<?php echo kayo_esc_style_attr( $text_style ); ?>"><?php the_title(); ?></a></h3>

							<?php do_action( 'kayo_work_metro_summary_end', $template_args ); ?>
						</div><!--  .entry-summary  -->
