...
class Elementor_Release_Index_Widget extends \Elementor\Widget_Base { // phpcs:ignore
	...
	public function __construct( $data = array(), $args = null ) { // phpcs:ignore
		...
		$this->params = kayo_release_index_params();
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor_Release_Index_Widget() );
