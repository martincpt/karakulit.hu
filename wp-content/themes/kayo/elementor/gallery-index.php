...
class Elementor_Gallery_Index_Widget extends \Elementor\Widget_Base { // phpcs:ignore
	...
	public function __construct( $data = array(), $args = null ) { // phpcs:ignore
		...
		$this->params = kayo_gallery_index_params();
	...
	/**
	 * Register Gallery Index widget controls.
	 *
	 */
	...
	protected function render() {
		...
		$atts['post_type'] = 'gallery';

		/**
		 * Uses the main post hook to display the galleries.
		 */
		do_action( 'kayo_posts', $atts );
	}
}
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor_Gallery_Index_Widget() );
