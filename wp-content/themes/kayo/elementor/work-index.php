...
class Elementor_Work_Index_Widget extends \Elementor\Widget_Base { // phpcs:ignore
	...
	public function __construct( $data = array(), $args = null ) { // phpcs:ignore
		...
		$this->params = kayo_work_index_params();
	...
	/**
	 * Register Work Index widget controls.
	 */
	...
	protected function render() {
		...
		/**
		 * Uses the main post hook to display the works.
		 */
		do_action( 'kayo_posts', $atts );
	}
}
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor_Work_Index_Widget() );
