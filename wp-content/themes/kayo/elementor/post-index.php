...
class Elementor_Post_Index_Widget extends \Elementor\Widget_Base { // phpcs:ignore
	...
	public function __construct( $data = array(), $args = null ) { // phpcs:ignore
		...
		$this->params = kayo_post_index_params();
	...
	protected function render() {
		...
		/**
		 * Uses the main post hook.
		 */
		do_action( 'kayo_posts', $atts );
	}
}
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor_Post_Index_Widget() );
