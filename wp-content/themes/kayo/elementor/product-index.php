...
class Elementor_Product_Index_Widget extends \Elementor\Widget_Base { // phpcs:ignore
	...
	public function __construct( $data = array(), $args = null ) { // phpcs:ignore
		...
		$this->params = kayo_product_index_params();
	...
	/**
	 * Register Product Index widget controls.
	 *
	 */
	...
	protected function render() {
		...
		/**
		 * Uses the main post hook to display the products.
		 */
		do_action( 'kayo_posts', $atts );
	}
}
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor_Product_Index_Widget() );
