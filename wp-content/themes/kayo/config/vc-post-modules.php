		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'kayo_post_display_options', array(
				...
				array(
					...
					'description' => sprintf(
						wp_kses_post( __( 'When using the manual excerpt, you must split your post using a "<a href="%s">More Tag</a>".', 'kayo' ) ),
				...
				array(
					...
					'save_always' => true,
					'description' => sprintf( wp_kses_post( __( 'Select how to sort retrieved posts. More at %s.', 'kayo' ) ), '<a href="http://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">WordPress codex page</a>' ),
					'group' => esc_html__( 'Query', 'kayo' ),
				),
				...
				array(
					...
					'save_always' => true,
					'description' => sprintf( wp_kses_post( __( 'Designates the ascending or descending order. More at %s.', 'kayo' ) ), '<a href="http://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">WordPress codex page</a>' ),
					'group' => esc_html__( 'Query', 'kayo' ),
				),
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'kayo_product_display_options', array(
				...
				array(
					...
					'heading' => esc_html__( 'Category', 'kayo' ),
					'type' => 'dropdown',
					'value' => kayo_get_product_cat_dropdown_options(),
				...
				array(
					...
					'value' => $order_by_values,
					'save_always' => true,
					'description' => sprintf( wp_kses_post( __( 'Select how to sort retrieved products. More at %s.', 'kayo' ) ), '<a href="http://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">WordPress codex page</a>' ),
					'group' => esc_html__( 'Query', 'kayo' ),
				),
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'kayo_event_display_options', array(
				...
				array(
					...
					'admin_label' => true,
					'dependency' => array( 'element' => 'event_display', 'value' => array( 'grid' ) ),
				),
...
class WPBakeryShortCode_Wvc_Event_Index extends WPBakeryShortCode {}
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'kayo_work_display_options', array(
				...
				array(
					...
					'value' => array(
						...
						//esc_html__( 'Flip Box', 'kayo' ) => 'flip-box',
					),
					'admin_label' => true,
					'dependency' => array(
						'element' => 'work_display',
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'kayo_release_display_options', array(
						'grid' => esc_html__( 'Grid', 'kayo' ),
					) ) ),
					'admin_label' => true,
				),
				...
				array(
					...
					'value' => kayo_get_metro_patterns(),
					'std' => 'auto',
					'dependency' => array( 'element' => 'release_display', 'value' => array( 'metro' ) ),
					'admin_label' => true,
				),
				...
				array(
					...
					'admin_label' => true,
					'dependency' => array(
						'element' => 'release_display', 'value' => array( 'grid' ) ),
				),
				...
				array(
					...
					'admin_label' => true,
					'dependency' => array( 'element' => 'release_layout', 'value' => array( 'overlay', 'flip-box' ) ),
				),

				// array(
				// 	'type' => 'dropdown',
				// 	'heading' => esc_html__( 'Text Alignment', 'kayo' ),
				// 	'param_name' => 'work_caption_align',
				// 	'value' => array(
				// 		esc_html__( 'Center', 'kayo' ) => 'center',
				// 		esc_html__( 'Left', 'kayo' ) => 'left',
				// 		esc_html__( 'Right', 'kayo' ) => 'right',
				...
				// array(
				// 	'type' => 'dropdown',
				// 	'heading' => esc_html__( 'Text Vertical Alignment', 'kayo' ),
				// 	'param_name' => 'work_caption_valign',
				// 	'value' => array(
				// 		esc_html__( 'Middle', 'kayo' ) => 'middle',
				// 		esc_html__( 'Bottom', 'kayo' ) => 'bottom',
				// 		esc_html__( 'Top', 'kayo' ) => 'top',
				...
				array(
					'type' => 'wvc_textfield',
					'heading' => esc_html__( 'Include Label', 'kayo' ),
					'param_name' => 'label_include',
					'description' => esc_html__( 'Enter one or several labels. Paste category slug(s) separated by a comma', 'kayo' ),
					'placeholder' => esc_html__( 'my-category, other-category', 'kayo' ),
					'group' => esc_html__( 'Query', 'kayo' ),
				),
				...
				array(
					'type' => 'wvc_textfield',
					'heading' => esc_html__( 'Exclude Label', 'kayo' ),
...
class WPBakeryShortCode_Wvc_Release_Index extends WPBakeryShortCode {}
